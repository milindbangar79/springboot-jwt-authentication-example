...
@AnalyzeClasses(packages = "com.springboot.jwt")
public class SpringBootJWTAuthenticationApplicationCodingRulesTest {

    @ArchTest
    final ArchRule no_access_to_standard_streams = NO_CLASSES_SHOULD_ACCESS_STANDARD_STREAMS;

    @ArchTest
    void no_access_to_standard_streams_as_method(JavaClasses javaClasses) {
        noClasses().should(ACCESS_STANDARD_STREAMS).check(javaClasses);
    }
